...
<!-- <div class="container pt-5">
  <div class="row">
    ...
    <div class="col-md-7 pl-5">
      <h1 class="schulung-h1">Wir bringen dein Unternehmen<br> ins digitale Zeitalter</h1>
      <p>Vertrau auf unsere jahrelange Erfahrung und lass dich von unseren erfolgreichen Projekten überzeugen. So zum Beispiel unsere <a href="https://coodoo.de/showcase-halbzeit-app" rel="noopener" target="_blank">HALBZEIT App.</a> </p>
        <div class="row pt-3">  
          <div class="col-6 col-lg-4">
             <h1 class="schulung-h1 mb-1"><strong>52.000</strong></h1>
             <p>Downloads</p></div>
          <div class="col-6 col-lg-4"><h1 class="schulung-h1 mb-1"><strong>4,6</strong> </h1>
              <p>Sterne</p></div>
           <div class="col-lg-4"><h1 class="schulung-h1 mb-1"><strong>200.000</strong></h1>
...
<div class="row text-center">
  ...
  <img class="team img-fluid" src="/images/Team/Tristan.jpg">
     ...
     <div class="col-6 col-lg-3 p-2">
        ...
        <p><strong>Arend Kühle</strong><br>
Backend Entwickler</p>
    </div>
    <div class="col-6 col-lg-3 p-2">
